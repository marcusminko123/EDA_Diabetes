...
db_new <- db %>% 
                ...
                mutate(Diabetes = recode(Diabetes_012, "0" = "NO", "2" = "YES")) %>%                select(Diabetes, HighBP, HighChol, BMI, Smoker, Sex, HeartDiseaseorAttack) 


#plot

db_new %>% 
           ggplot(aes(x = HeartDiseaseorAttack)) + geom_bar () + facet_grid(Diabetes ~ Smoker, scales = "free")
```
